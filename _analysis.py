...
def main():
    ...
    # tasks_full_run_0 = [MUFFIN_TASK]
    # dummies_full_run_0 = ["full_run_0"]
    # results = get_available_results(tasks_full_run_0, dummies_full_run_0)
    ...
    tasks_full_run_0 = CUSTOM_TASKS
    dummies_full_run_0 = ["full_run_0"] * len(tasks_full_run_0)
